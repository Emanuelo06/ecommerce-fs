 ...
 * /orders:
 *   get:
 *     summary: Get orders with pagination and filtering (user sees only their orders, admin sees all)
 *     tags: [Orders]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *               $ref: '#/components/schemas/Order'
 *       400:
 *         description: Cannot cancel order (already shipped/delivered) or access denied
 */
